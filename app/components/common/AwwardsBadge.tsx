...
const AwwardsBadge = () => {
  ...
  return (
    ...
    >
      <a href="https://ashutoshjoshi1.github.io" target="_blank">
        <svg width="53.08" height="171.358">
          <path className="js-color-bg" fill="#050510" d="M0 0h53.08v171.358H0z"></path>
          <g className="js-color-text" fill="#00f0ff" ref={fillRef}>
            <path
